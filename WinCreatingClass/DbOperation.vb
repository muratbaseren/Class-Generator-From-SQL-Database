...
Public Class DbOperations
    ...
    'Insert sorgusu olusturularak çalýþtýrýlýr.
    ...
    'Update sorgusu olusturularak çalýþtýrýlýr.
    Public Function Update(ByVal ConnectionString As String, ByVal TableName As String, ByVal ColumnsValues As ArrayList, ByVal OrginalValues As ArrayList) As Integer
        ...
        'Update sorgusunda <where> den onceki kýsýmý olusturur..
        For Each param As QueryValues In ColumnsValues
        ...
        'Tum kolonlarýn OrginalValue larý ile sorgudan <where> den sonraki kýsmý olusturur..
        'DataGrid'de seçilen satýr deðerleri Orginalvalues dizisinden okunur ve sorgu lsuturulur..
    ...
    'Delete sorgusu olusturularak çalýþtýrýlýr.
    Public Function Delete(ByVal ConnectionString As String, ByVal TableName As String, ByVal OrginalValues As ArrayList) As Integer
        ...
        'Sorgunun sonuna fazladan [ AND ] eklendiði için bu silinir..
